...
const CustomerServiceIssuesAddNew = () => {
  return (
    <>
      <div className="">
        {/* basic info */}
        ...
        <div className="mt-5 basicInfo d-flex justify-content-evenly position-relative">
          ...
          <div className="row ">
            <div className="col-12 d-flex justify-content-around">
              <div className="col-5">
                <div className="mb-3 mt-4">
                  <label className="form-label"> Associated PO Number</label>
                  <input type="text" className="form-control" />
                </div>
                <div className="mb-3">
                  <label className="form-label">
              ...
              <div className="col-5">
                <div className="mb-3 mt-4">
                  <label className="form-label">Associated Order Number</label>
                  <input type="text" className="form-control" />
                </div>
                <div className="mb-3">
                  <label className="form-label">
                    <span className="text-danger">*</span> Net Value of DIF or
                    CM Amount
                  </label>
                  <input type="text" className="form-control" />
                </div>{" "}
...
export default CustomerServiceIssuesAddNew;
