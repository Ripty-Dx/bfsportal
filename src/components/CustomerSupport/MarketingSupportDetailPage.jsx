...
import MarketingSupportIssueTable from "./MarketingSupportIssueTable";
import { BiLeftArrowAlt } from "react-icons/bi";

const MarketingSupportDetailPage = ({ details, apiData }) => {
  console.log(details);
  const [backToMarketingSupportIssue, setBackToMarketingSupportIssue] =
    useState(false);
  const handleBackToManagementCase = () => {
    setBackToMarketingSupportIssue(true);
  };
  return (
    <>
      {backToMarketingSupportIssue ? (
...
export default MarketingSupportDetailPage;
